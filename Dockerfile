...
ENV GRAAL_FOLDERNAME graalvm-ce-java19-${GRAAL_VERSION}
ENV GRAAL_FILENAME graalvm-ce-java19-linux-aarch64-${GRAAL_VERSION}.tar.gz
...
WORKDIR /meetrics-lambda-function
